...
const Dashboarduser = () => {
  return (
    <DashboardLayout>
      <h1 className="font-sans font-bold text-3xl text-black mb-4">User</h1>
      <div className="flex mb-6 justify-between max-lg:justify-center max-lg:block">
        <div
          className="inline-flex rounded-md shadow-sm max-lg:w-full max-lg:mb-2"
          role="group"
        >
          <button
            type="button"
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/dashboard/user/createuser"
        ...
        <table className="w-full text-sm text-left rtl:text-right text-black ">
          ...
          <tbody>
            <tr className="bg-white border-b hover:bg-gray-50">
              ...
              <td className="px-6 py-4">rizalfuad@gmail.com</td>
              <td className="px-6 py-4">
                fbfb5013429b9a35b21c99b040d9c20692f0c0fe97b1e4e7061b349ce70c24a3
              </td>
              ...
              <td className="px-6 py-4">
                ...
                <div className="flex items-center justify-center">
                  <Link
                    href="/dashboard/user/updateuser"
                  ...
                  <Link
                    href=""
                    className="px-6 py-2 text-sm font-bold text-red-500 bg-white border border-gray-200 rounded-e-lg hover:bg-gray-100 hover:text-red-600 focus:z-10 focus:ring-red-600 focus:text-red-600"
                  >
                    <svg
                      width="18"
                      height="18"
