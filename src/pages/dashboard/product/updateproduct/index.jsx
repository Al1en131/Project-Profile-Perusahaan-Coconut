...
const DashboardUpdateproduct = () => {
  ...
  const isFormFilled = () => {
    return file && productName && category && price && description;
  };
  return (
    <DashboardLayout>
      <Link
      ...
      <form action="">
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full md:w-1/2 px-3 max-lg:mb-6">
            <label
              className="block text-black text-xs font-bold mb-2"
              htmlFor=""
            >
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full px-3">
            ...
            <textarea
              className="no-resize appearance-none block w-full bg-white text-black border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
              id="grid-description"
