...
export default function Product() {
  ...
  return (
    <div className=" ">
      {/* Hero */}
      <div className="text-center font-montserrat h-[400px] mt-16 max-lg:h-[263px] relative">
        <Image
          src="/image/hero-product.png"
          alt=""
          fill
          className="w-full object-cover"
        />
        <div className=" absolute transform left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2">
          <p className=" font-semibold text-3xl text-white">Product</p>
          <svg
            width="288"
            height="2"
            className="mt-4"
      ...
      <div className="px-[120px] max-lg:px-8">
        <div className="justify-between max-lg:justify-center max-lg:flex-col max-lg:space-y-5 max-lg:w-full items-center flex pt-14 max-lg:pt-10 pb-10">
          <div className="flex items-center font-montserrat border w-[392px] max-lg:w-full h-[44px] border-gray-400 bg-white rounded-lg">
            <div className="w-full">
              <input
                type="search"
                className="w-full h-full px-4 py-1 text-gray-800 text-xl max-lg:text-xs font-poppins font-medium rounded-lg focus:outline-none"
                placeholder="Search"
                value={search}
            ...
            <div>
              <button
                type="submit"
                className={`flex items-center justify-center w-[44px] h-[44px] text-white rounded-r-lg ${
                  search.length > 0
                    ? "bg-[#73d234]"
                    : "bg-[#3F9D00] cursor-not-allowed"
                }`}
          ...
          <div className="flex gap-2 items-center font-poppins max-lg:w-full max-lg:overflow-x-hidden">
            <svg
              width="24"
              height="22"
              viewBox="0 0 24 22"
            ...
            <button
              type="button"
              className="text-white bg-[#3F9D00] border border-[#3F9D00] focus:outline-none  focus:bg-[#3F9D00] focus:text-white font-semibold rounded-full text-base font-poppins px-4 py-1 text-center"
            >
              All
            </button>
            <button
              type="button"
              className="text-black bg-transparent border border-[#3F9D00] focus:outline-none  focus:bg-[#3F9D00] focus:text-white font-semibold rounded-full text-base font-poppins px-4 py-1 text-center"
            >
              Charcoal
            </button>
            <button
              ...
              <div className="px-4 py-6 max-lg:px-0 max-lg:py-2">
                ...
                <h3 className="mt-3 font-medium text-base max-lg:text-xs font-poppins text-[#868686] pb-4">
                  <Link href="/productdetail">
                    ...
                    Laborum vitae itaque, asperiores neque possimus praesentium
                    pariatur sint officia vero adipisci aliquid sapiente.
                    Obcaecati voluptate aut consectetur, aperiam labore minus
                    nostrum.
                  </Link>
                </h3>
